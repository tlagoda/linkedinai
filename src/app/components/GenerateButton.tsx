...
const GenerateButton = ({
  ...
  return (
    <button
      className="text-3xl w-full h-3/5 py-10 border-violet-500 border-8 text-slate-100 py-2 px-4 rounded-3xl transition-colors duration-200 flex items-center justify-center hover:bg-purple-800 hover:text-white hover:border-purple-800"
