  ...
  return (
    <main>
      <div className="min-h-screen font-mono w-screen">
        <div className="md:h-screen w-screen bg-gray-900 pt-4 pb-10 md:pb-0">
          <Header />
          <div className="flex flex-col md:flex-row items-center mt-20 md:mx-20">
            <div className="w-11/12 md:w-6/12 px-8 flex flex-col items-center">
              ...
              <p className="text-l text-slate-300 text-center">
                ...
                <span className="text-emerald-400">AI</span> with our
                next-generation LinkedIn posting tool. Craft{" "}
                <span className="text-emerald-400">
                  engaging, top-quality content
                </span>{" "}
                and share it directly to your network with ease. Our
                sophisticated algorithms turn your ideas into compelling
                narratives, making professional networking{" "}
